...
public class Student {
    ...
    public void enroll(Course course) {
        this.course = course;
        System.out.println(name + " 이(가) " + course.getName() + " 을(를) 수강합니다 ");
    }
    ...
    public void end() {
        if (this.course != null) {
            System.out.println(course.getName() + " 수강 취소 완료");
            this.course = null;
        } else {
    ...
    public void showCourse() {
        if (this.course != null) {
            System.out.println(this.name + " 이(가) " + this.course.getName() + " 을 수강하고 있는 중");
        } else {
